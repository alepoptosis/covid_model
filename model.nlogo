...
<experiments>
  ...
  <experiment name="vary-ld-compliance" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count susceptibles</metric>
    <metric>count exposeds</metric>
  ...
  <experiment name="vary-sv-compliance" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count susceptibles</metric>
    <metric>count exposeds</metric>
  ...
  <experiment name="vary-pp-strength" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count susceptibles</metric>
    <metric>count exposeds</metric>
  ...
  <experiment name="vary-pp-compliance" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count susceptibles</metric>
    <metric>count exposeds</metric>
